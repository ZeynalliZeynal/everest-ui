...
const SvgTruckRemove = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      ...
      strokeMiterlimit={10}
      strokeWidth={1.5}
      d="M9 5c0 .75-.21 1.46-.58 2.06-.21.36-.48.68-.79.94-.7.63-1.62 1-2.63 1a3.97 3.97 0 0 1-3.42-1.94A3.9 3.9 0 0 1 1 5c0-1.26.58-2.39 1.5-3.12A3.999 3.999 0 0 1 9 5M6.07 6.04 3.96 3.93M6.04 3.96 3.93 6.07"
    />
  </svg>
);
