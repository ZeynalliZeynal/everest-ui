...
const SvgGameboy = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      ...
      strokeMiterlimit={10}
      strokeWidth={1.5}
      d="M16.25 11h-8.5C6.79 11 6 10.21 6 9.25v-2.5C6 5.79 6.79 5 7.75 5h8.5c.96 0 1.75.79 1.75 1.75v2.5c0 .96-.79 1.75-1.75 1.75M10.3 15.28 8 17.58M8.03 15.31l2.3 2.3"
    />
    <path
      stroke="currentColor"
      strokeLinecap="round"
