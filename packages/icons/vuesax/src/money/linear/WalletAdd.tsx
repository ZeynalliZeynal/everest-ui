...
const SvgWalletAdd = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      strokeWidth={1.5}
      d="M17.751 7.05c-.24-.04-.49-.05-.75-.05h-10q-.42 0-.81.06c.14-.28.34-.54.58-.78l3.25-3.26a3.525 3.525 0 0 1 4.96 0l1.75 1.77c.64.63.98 1.43 1.02 2.26"
    />
    <path
      stroke="currentColor"
      strokeLinecap="round"
      ...
      strokeMiterlimit={10}
      strokeWidth={1.5}
      d="M9 19c0 .75-.21 1.46-.58 2.06A3.97 3.97 0 0 1 5 23a3.97 3.97 0 0 1-3.42-1.94A3.9 3.9 0 0 1 1 19c0-2.21 1.79-4 4-4s4 1.79 4 4M6.492 18.98h-2.98M5 17.52v2.99"
    />
    <path
      stroke="currentColor"
      strokeLinecap="round"
