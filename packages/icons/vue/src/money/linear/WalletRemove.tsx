...
const SvgWalletRemove = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      ...
      strokeMiterlimit={10}
      strokeWidth={1.5}
      d="M9 19c0 .75-.21 1.46-.58 2.06-.21.36-.48.68-.79.94-.7.63-1.62 1-2.63 1a3.97 3.97 0 0 1-3.42-1.94A3.9 3.9 0 0 1 1 19a4 4 0 0 1 1-2.64C2.73 15.53 3.8 15 5 15c2.21 0 4 1.79 4 4M6.071 20.04l-2.11-2.11M6.04 17.96l-2.11 2.11"
    />
  </svg>
);
