...
const SvgFloorLampMinimalistic = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      stroke="#000"
      strokeWidth={1.5}
      d="M12 8c2.337 0 4.3-1.282 4.847-3.016C17.014 4.458 16.552 4 16 4H8c-.552 0-1.014.458-.847.984C7.7 6.718 9.663 8 12 8ZM12 2c1.657 0 3 .895 3 2H9c0-1.105 1.343-2 3-2Z"
    />
    <path
      stroke="#000"
      strokeLinecap="round"
