...
const SvgLikeDislike = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      ...
      strokeWidth={1.5}
      d="M2 20.28v-5.6c0-.8.34-1.09 1.14-1.09h.57c.8 0 1.14.29 1.14 1.09v5.6c0 .8-.34 1.09-1.14 1.09h-.57c-.8 0-1.14-.28-1.14-1.09"
    />
    <path
      stroke="currentColor"
      strokeMiterlimit={10}
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M22 3.72v5.6c0 .8-.34 1.09-1.14 1.09h-.57c-.8 0-1.14-.29-1.14-1.09v-5.6c0-.8.34-1.09 1.14-1.09h.57c.8 0 1.14.28 1.14 1.09"
    />
  </svg>
);
