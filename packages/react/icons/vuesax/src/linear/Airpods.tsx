...
const SvgAirpods = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      ...
      strokeMiterlimit={10}
      strokeWidth={1.5}
      d="M5.78 6.72a.939.939 0 1 1 0-1.88M17.28 9.56h.94c2.08 0 3.78-1.7 3.78-3.78S20.3 2 18.22 2h-1.89a2.84 2.84 0 0 0-2.83 2.83V17.1c0 1.04.85 1.89 1.89 1.89s1.89-.85 1.89-1.89z"
    />
    <path
      stroke="currentColor"
      strokeLinecap="round"
