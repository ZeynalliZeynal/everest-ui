...
const SvgMessageAdd = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      ...
      strokeMiterlimit={10}
      strokeWidth={1.5}
      d="M9 17.5q0 .48-.12.93c-.09.4-.25.79-.46 1.13A3.97 3.97 0 0 1 5 21.5a3.92 3.92 0 0 1-2.66-1.03c-.3-.26-.56-.57-.76-.91A3.9 3.9 0 0 1 1 17.5a3.995 3.995 0 0 1 4-4c1.18 0 2.25.51 2.97 1.33.64.71 1.03 1.65 1.03 2.67M6.49 17.48H3.51M5 16.02v2.99M8.5 10.5h7"
    />
  </svg>
);
