...
const SvgBoxTick = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      strokeMiterlimit={10}
      strokeWidth={1.5}
      d="M23 17.91c.02.75-.18 1.46-.54 2.07-.2.36-.47.69-.77.96-.69.64-1.6 1.03-2.61 1.06-1.46.03-2.75-.72-3.46-1.87-.38-.59-.61-1.3-.62-2.05-.03-1.26.53-2.4 1.43-3.15.68-.56 1.54-.91 2.48-.93A4 4 0 0 1 23 17.91"
    />
    <path
      stroke="currentColor"
      strokeLinecap="round"
