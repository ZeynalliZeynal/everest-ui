...
const SvgScanBarcode = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M18.5 7v2q0 1.5-1.5 1.5h-2q-1.5 0-1.5-1.5V7q0-1.5 1.5-1.5h2q1.5 0 1.5 1.5M10.5 15v2q0 1.5-1.5 1.5H7q-1.5 0-1.5-1.5v-2q0-1.5 1.5-1.5h2q1.5 0 1.5 1.5M18.5 15v2q0 1.5-1.5 1.5h-2q-1.5 0-1.5-1.5v-2q0-1.5 1.5-1.5h2q1.5 0 1.5 1.5"
    />
  </svg>
);
